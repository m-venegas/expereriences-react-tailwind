    ...
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
        <div className='grid grid-cols-2 grid-rows-6 h-[80vh] '>
            ...
            <div className='flex flex-col h-full justify-center ' >
                    ...
                    <p className='text-2xl py-6' >Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, consequuntur?</p>
                    <p className='pb-6' >Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium magni autem excepturi sapiente corporis dolorem doloremque iusto accusamus! Omnis illo neque voluptatibus accusamus aliquam voluptate. Dolor aliquam illum quam corrupti?</p>
